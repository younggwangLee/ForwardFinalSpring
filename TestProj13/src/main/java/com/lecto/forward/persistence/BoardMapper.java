...
public interface BoardMapper {
	...
	public int deleteBoard(String boardCode) throws Exception;
	public int deleteBoards(List<String> boardCodes) throws Exception;
	public int deleteBoardName(List<String> boardName) throws Exception;
