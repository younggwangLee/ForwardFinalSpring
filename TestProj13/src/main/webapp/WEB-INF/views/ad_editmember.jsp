...
<div id="content">
   	 	<div class="well text-center meml">
   	 		<h2 style="font-weight:bold;color:white;">회원 관리</h2>    
 	 	</div>
          ...
          <div class="well" style="height:100%;background:white;">
            <div class="container-fluid">
			  ...
			  <br>
				...
				<div class="form-group row">
				  <a class="btn button" style="font-weight: bold;" id="btnSubmit">제출</a>
				  <a href="/ad_memberlist" class="btn button" style="font-weight: bold;" id="btnCancel">취소</a>
				</div>
			</form>
			</div>
		</div>
