...
<div id="content">
   	 	<div class="well text-center meml">
   	 		<h2 style="font-weight:bold;color:white;">운영자 추가</h2>    
 	 	</div> 
          ...
          <div class="well" style="height:100%;background:white;">
            <div class="container-fluid">
			  ...
			  <br>
				...
				<div class="form-group row ">
				  <a href="/ad_addmanager" class="btn button" id="btnSubmit" style="font-weight: bold;" >제출</a>
				  <a href="/ad_managerlist" class="btn button" id="btnCancel"> 취소</a>
				</div>
			</form>
			</div>
		</div>
