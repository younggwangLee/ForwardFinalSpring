...
<head>
  ...
  <style>
  	...
  	body{
  	 	/* background-image: url("http://192.168.43.115:8083/webProject/images/tennis3.png"); */
  	 	/* background-repeat: no-repeat;
  	 	background-size: cover; */
  	 	color: white;
  	}
...
<div id="content">
   	 <div class="well text-center head meml">
   	 	<h2 style="font-weight:bold;color:#F6F6F6">AdminMaster</h2>
    	<h4 style="color:#F6F6F6;">게시판 관리 프로그램</h4>      
 	 </div>
 	 	<div class="innerwrap">
        <div class="col-sm-5">
          <div class="well" style="height:100%;background:white;">
            <div class="container-fluid">
			  ...
			  <a href="a_articlelist?selectBoardName=자유게시판" class="btn button" style="font-weight: bold;">더보기</a>
			</div>
          </div>
        </div>
        ...
        <div class="col-sm-5">
          <div class="well" style="height:100%;background:white;">
            <div class="container-fluid">
			  ...
			  <a href="/a_articlelist?selectBoardName=공지사항" class="btn button" style="font-weight: bold;">더보기</a>
			</div>
          </div> 
        </div>	
        </div>
