  ...
  <script>
 	 $(document).ready(function(e){
		$('#btnSubmit').click(function(e){		
			var form = $('.mainForm');
			/* var newpwd = $("#newMemberPwd");
			var newRepwd = $("#checkPwd");
			if(enwpwd == newRepwd){ */
				form.attr('method', 'post');
				form.attr('action', '/ad_admininfo');
				form.submit();
			/* }else{
				alert("비밀번호 확인이 틀립니다. 다시 입력해주세요.");
			} */
		});
...
<div id="content">
   	 <div class="well text-center ad">
   	 		<h2 style="font-weight:bold;color:white;">관리자 정보 변경</h2>    
 	 </div>
        ...
        <div class="col-sm-10">
          <div class="well" style="height:100%;background:white;">
            ...
            <h4 style="font-weight:bold;">관리자 비밀번호 변경</h4><br>  
				...
				<div class="form-group row">	     	 
			     	 <a href="#"class="btn button" style="font-weight:bold" id="btnSubmit">수정</a>
			   	</div>
			    </form>
	   		 </div>
		</div>
