...
<div id="content">
   	 	<div class="well text-center meml">
   	 		<h2 style="font-weight:bold;color: white">운영자 관리</h2>    
 	 	</div>
        ...
        <div class="col-sm-10">
          <div class="well" style="height:100%;background:white;">
			...
			<form class ="mainForm">
				...
				<div class="form-group row ">
				  	<a class="btn button" id="btnSubmit" style="font-weight: bold;">제출</a>
				   	<a href="#" class="btn button" style="font-weight: bold;" id="btnCancel"> 취소</a>
				</div>
			</form>	
