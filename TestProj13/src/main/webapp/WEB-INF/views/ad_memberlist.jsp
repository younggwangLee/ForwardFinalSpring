...
<head>
  ...
  <link rel="stylesheet" href="http://192.168.43.115:8083/webProject/css/mycss.css">
...
<div id="content">
   	 	<div class="well text-center meml">
   	 		<h2 style="font-weight:bold;color:#F6F6F6" >회원 관리</h2>
 	 	</div>
        ...
        <div class="col-sm-10">
          <div class="well" style="height:100%;background:white;">
            <div class="container-fluid">
			 <div style="font-weight:bold;">회원 목록</div>
			  ...
			  <br>
			 	<div class="search">
					...
					<a class="btn button" id="btnSearch" style="margin-top: 0px; font-weight: bold;">검색</a>
			    ...
			    <tbody>
			  	<c:if test="${memberList ne null }">
			  	  	<c:forEach var="member" items="${memberList}" >
				     	<tr id="tr" style="cursor: pointer; height:50px;">
			...
			<div class="text-center">
				...
				<a class="btn button pull-right" id="memDel" style="font-weight: bold;">회원 삭제</a>
			  <!-- <button type="button" class="btn mybtn pull-right" id="memDel">회원 삭제</button> -->			  
			  <a href="/ad_addmember" class="btn button pull-right" style="font-weight: bold;">회원 추가</a>
			</div>
          </div>
        </div>   
        </form> 
